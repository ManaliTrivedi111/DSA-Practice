...
# Problem Summary: There are n houses evenly lined up on the street, and each house is beautifully painted. You are given a 0-indexed integer array colors of length n, where colors[i] represents the color of the ith house.
Return the maximum distance between two houses with different colors.

# Approach Used: The solution compares colors from both ends of the array, calculates maximum distances from the left and the right sides, and returns the larger of the two. 
